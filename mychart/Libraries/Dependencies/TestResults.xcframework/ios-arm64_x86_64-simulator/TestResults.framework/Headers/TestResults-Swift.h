...
- (UIViewController * _Nullable)getTestResultsViewController:(PEPatientContext * _Nonnull)encounterContext viewControllerTitle:(NSString * _Nullable)viewControllerTitle SWIFT_WARN_UNUSED_RESULT;
