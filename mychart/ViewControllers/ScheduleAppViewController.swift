//
//  ScheduleAppViewController.swift
//  App
//
...
class ScheduleAppViewController: UIViewController,  WKNavigationDelegate,WKUIDelegate {
    ...
    override func viewDidLoad() {
        ...
        super.viewDidLoad()
        WebView = WKWebView()
        WebView.frame  = CGRect(x: 0, y: 0, width: UIScreen.main.bounds.width, height: UIScreen.main.bounds.height - 95)
