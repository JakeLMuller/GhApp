...
//  mychart
//
//  Created by Garnet Health on 4/21/21.
...
class MainLoginViewController: UIViewController, UITextFieldDelegate, WPAPIAuthenticationDelegate  {
    ...
    @IBAction func signUpAction(_ sender: Any) {
        let vc = UIStoryboard.init(name: "HomeScreen", bundle: Bundle.main).instantiateViewController(withIdentifier: "signUp")
    ...
    @IBAction func fPassword(_ sender: Any) {
        let vc = UIStoryboard.init(name: "HomeScreen", bundle: Bundle.main).instantiateViewController(withIdentifier: "fPassWord")
                          self.navigationController?.pushViewController(vc, animated: true)
    }
       ...
       var activityIndicator: UIActivityIndicatorView!
        ...
        override func viewDidLoad() {
           ...
           mainLogo.frame.size.height = (screenHeight * 0.18);
            ...
            var currentHeightOffest =   (screenHeight * 0.18) + 80;
            if (screenWidth > 450){
