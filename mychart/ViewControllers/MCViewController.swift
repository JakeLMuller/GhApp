...
//  mychart
//
//  Created by Garnet Health on 8/18/21.
//

import UIKit
import WebKit
class MCViewController: UIViewController,  WKNavigationDelegate,WKUIDelegate{
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: "https://www.garnethealth.org/locations?location_type=15")!
