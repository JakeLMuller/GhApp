//
//  NewsConainterViewController.swift
//  mychart
//
...
class NewsConainterViewController:
    UIViewController {
       var menuController : MenuViewController!
           ...
           func setHomeFun(index:Int){
               if (index == 1) {
                   ...
                   homeVC.navigationController?.pushViewController(NewsViewController(), animated: true)
               }
               else  if index == 3{
       ...
       extension NewsConainterViewController : MenuDelegate{
