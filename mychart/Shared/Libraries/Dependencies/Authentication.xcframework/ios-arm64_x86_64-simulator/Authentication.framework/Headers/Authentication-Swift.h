...
/// UINavigationController for the two factor authentication workflow. The controller automatically determines the correct root view controller based on the number of available delivery methods for two factor codes.
SWIFT_CLASS("_TtC14Authentication43TwoFactorAuthenticationNavigationController")
@interface TwoFactorAuthenticationNavigationController : UINavigationController
...
/// UINavigationController for the two-factor enrollment workflow. The controller automatically sets the root view controller to an instance of TwoFactorEnrollmentViewController.
SWIFT_CLASS("_TtC14Authentication39TwoFactorEnrollmentNavigationController")
@interface TwoFactorEnrollmentNavigationController : UINavigationController
/// UINavigationController
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder SWIFT_UNAVAILABLE;
/// UINavigationController
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil SWIFT_UNAVAILABLE;
