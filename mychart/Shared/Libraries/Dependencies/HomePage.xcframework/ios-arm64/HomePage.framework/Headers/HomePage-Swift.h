...
@interface HPConversationFeedItem (SWIFT_EXTENSION(HomePage))
...
@interface HPMessageFeedItem (SWIFT_EXTENSION(HomePage))
@property (nonatomic, readonly, copy) NSString * _Nonnull imageURL;
@end
...
@interface HPTestResultFeedItem (SWIFT_EXTENSION(HomePage))
@property (nonatomic, readonly, copy) NSString * _Nonnull imageURL;
@end
...
/// this copy is necessary until the min version is iOS 13, at which point subclasses may extend as @objc within homepage
SWIFT_CLASS("_TtC8HomePage42PEOrganizationInfoCopyFromPECoreUntilIOS13") SWIFT_AVAILABILITY(ios,deprecated=13.0)
@interface PEOrganizationInfoCopyFromPECoreUntilIOS13 : NSObject <ImageDataSource, PEOrganizationInfoProtocol>
